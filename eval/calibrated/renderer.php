 ...
 */
class workshepeval_calibrated_renderer extends plugin_renderer_base {

    protected function render_workshep_calibrated_evaluation_explanation(workshep_calibrated_evaluation_explanation $explanation) {
        ...
        $accuracy_curve = workshep_calibrated_evaluation::$grading_curves[$explanation->accuracy];
        ...
        $consistency_curve = workshep_calibrated_evaluation::$grading_curves[9 - $explanation->consistency];
