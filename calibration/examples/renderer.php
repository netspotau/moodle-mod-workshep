...
/**
 * workshep module renderer class
 *
 * @copyright 2009 David Mudrak <david.mudrak@gmail.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class workshepcalibration_examples_renderer extends plugin_renderer_base {

    protected function render_workshep_examples_calibration_explanation(workshep_examples_calibration_explanation $explanation) {

        if (isset($explanation->empty)) {
            return $this->output->heading(get_string("noexamples", "workshepcalibration_examples"));
        }
        ...
        $accuracy_curve = workshep_examples_calibration_method::$grading_curves[$explanation->accuracy];
        ...
        $consistency_curve = workshep_examples_calibration_method::$grading_curves[9 - $explanation->consistency];
