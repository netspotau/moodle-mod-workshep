 ...
 * workshep_assessments table.
 */
interface workshep_allocator {
     ...
     *
     * @param stdClass $wsoutput workshep module renderer can be used
 ...
 */
class workshep_allocation_result implements renderable {
    ...
    /** @var workshep_allocator the instance of the allocator that produced this result */
    protected $allocator;
     ...
     *
     * @param workshep_allocator $allocator
     */
    public function __construct(workshep_allocator $allocator) {
