...
class workshep_teammode_random_allocator extends workshep_random_allocator {

    protected $form_class = 'workshep_teammode_random_allocator_form';
    ...
    protected function get_authors() {
        global $DB;
        $rslt = $this->workshep->get_submissions_grouped();
